            ...
            <main>
                ...
                <div class="box">
                        ...
                        <dd class="answer"><p>
                                ...
                                表素材（ビニールレザー）などもサンゲツやシンコーなど大手張地メーカーのものを使用しておりますので、安心してご利用ください。</p></dd>
                        </dl>
                        <dl>
                        ...
                        <dd class="answer"><p>
                                ...
                                納入事例を見ていただければ安心していただけるかと存じますので、ぜひご覧ください。<br><br>
                                また、弊社にご来社いただければ、実際の制作現場もご覧いただくことも可能です。<br>（事前予約が必要となりますので、ご連絡くださいませ。）</p></dd>
                        </dl>
                        <dl>
                        ...
                        <dd class="answer"><p>
                            量は対象年齢によっても異なりますが、1㎡当たり深さ/15～17ｃｍほどで500個、20ｃｍほどで750個くらいと<br>
                            させていただいております。（弊社の70ｍｍのボールサイズの場合）<br><br>
                        ...
                        <dd class="answer"><p>
                            ...
                            「単色」「ミックス」「ハーフ＆ハーフ」の3パターンの梱包形態をご用意しておりますので、お好きなように<br>
                            組み合わせていただきます。</p>
                        </dd>
                        </dl>
                        <dl>
                        ...
                        <dd class="answer"><p>
                                ...
                                タイの方でも多少在庫をもっており、またタイの工場とも密にやり取りを行っておりますので、お急ぎの場合は<br>
                                一度ご相談ください。</p>
                        </dd>
                        </dl>
                        <dl class="last">
