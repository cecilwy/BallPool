                    ...
                    <div class="item-detail box">
                        <div class="item-wrap">
                            ...
                            <div class="item-info">
                                ...
                                <p class="btn01"><a href="javascript:void(0);" onClick="window.open('https://systemsofa.com/MailSystem/user/?reffere=coto-kito.com', 'mywindow4', 'width=780, height=850, menubar=no, toolbar=no, scrollbars=yes');">ご相談・お見積もり</a></p>
                            </div>
                        </div>
